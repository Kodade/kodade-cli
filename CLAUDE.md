...
## Status
v0.1.0 released (M0–M4 complete: multiplexer, mouse, agent detection, sidebar, scripting CLI, config/themes, copy mode, release pipeline) — last touched 2026-09-01
